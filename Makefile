...
SOURCES := src/page.cpp src/heap_file.cpp src/buffer_pool.cpp src/record_store.cpp src/tuple.cpp src/catalog.cpp
HEADERS := include/pageforge/page.hpp include/pageforge/heap_file.hpp include/pageforge/buffer_pool.hpp include/pageforge/record_store.hpp include/pageforge/tuple.hpp include/pageforge/catalog.hpp
